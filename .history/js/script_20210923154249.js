...
var fadeTrigger = document.getElementById("vidContainer");
function fadeOutEffect() {
  var fadeTarget = document.getElementById("fade-container");
...
fadeTarget.addEventListener('onmouseover', fadeOutEffect);
